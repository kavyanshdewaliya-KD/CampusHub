# 🎓 CampusHUB — IET DAVV CSE-B

CampusHUB is a high-utility, mobile-first Web Application and Progressive Web App (PWA) engineered specifically for the 80-student batch of **IET DAVV CSE-B**. Built to streamline academic life, it bridges personal productivity with batch-wide connectivity in one real-time dashboard.
